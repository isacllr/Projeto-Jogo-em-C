...
int main(){
   ...
   while( opcao != 4){
    ...
    if(opcao == 1){
        ...
        printf("==Nesse jogo, voce tera 5 perguntas com 4 alternativas cada uma, ao acertar uma pergunta voce pontua 5 pontos==\n\n");
        ...
        printf("==A historia do jogo se passa dentro de uma tumba egipcia onde dois exploradores ficaram presos. No centro da sala, ha cinco caixas: uma delas contem o botao para abrir a porta que caso voce ache, ganha o jogo enquanto uma outra esconde uma cobra mortal e caso voce a encontre, perde o jogo. A cada rodada (final do jogo), o local do botão e da cobra muda de caixa de forma aleatoria.==\n\n");
         ...
         printf(" 1) Alex\n 2) Joe\n 3) Marcos\n 4) Mortheus\n 5) Sasha\n 6) Rayleigh\n 7) Kayle\n");
            ...
            while(jogarNovamente3 == 1){
                ...
                int turno = 1;
                int vencedor = 0;
                 printf("O jogo eh baseado em dois jogadores, cada um controlando duas gousmas com o nivel de furia 1 cada uma. O objetivo eh destruir as gousmas do adversario, fazendo com que a forca delas ultrapasse 5 ou caia para 0 ou menos. Os jogadores podem escolher entre atacar a gousma do adversario ou dividir a forca entre suas proprias gousmas. O jogo continua ate que um dos jogadores perca ambas as gosmas, declarando o outro jogador como vencedor.");
                while(vencedor == 0)
                {
                    printf("\n=====STATUS=====");
                    printf("\nJ1: %d %d\n", f1, f2);
